...
/**
 * The documentation, on GitBook.
 *
 * GitBook's own mark, so the link says where it goes before it is read. The
 * mark is Simple Icons' (CC0), drawn as one path in the link's colour rather
 * than fetched, so the footer costs no request and follows the theme.
 */
const GITBOOK_MARK =
...
const DocsLink = () => (
  <a href={DOCS_URL} target="_blank" rel="noopener noreferrer" className="sa-docs">
