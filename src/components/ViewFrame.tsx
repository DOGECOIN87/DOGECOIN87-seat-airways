  ...
  return (
    <div className="relative">
      <div
        ...
        onKeyDown={onKeyDown}
        className={`relative overflow-hidden border border-white/12 bg-[#05070F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-seat-cyan ${
